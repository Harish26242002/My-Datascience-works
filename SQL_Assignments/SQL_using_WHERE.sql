...
--SELECT CUST_ID,CUST_FIRST_NAME,CUST_INCOME_LEVEL FROM SH.CUSTOMERS 
--WHERE CUST_INCOME_LEVEL='G: 130,000 - 149,999';

--5. Get all customers with a credit limit above 10,000.
--SELECT CUST_ID,CUST_FIRST_NAME,CUST_CREDIT_LIMIT FROM SH.CUSTOMERS 
--WHERE CUST_CREDIT_LIMIT=10000;

--6. Retrieve customers from the state "California".
--SELECT CUST_STATE_PROVINCE FROM SH.CUSTOMERS 
...
--SELECT CUST_ID,CUST_MARITAL_STATUS FROM SH.CUSTOMERS WHERE CUST_MARITAL_STATUS = NULL
...
--SELECT CUST_ID,CUST_MARITAL_STATUS,CUST_INCOME_LEVEL FROM SH.CUSTOMERS WHERE CUST_INCOME_LEVEL = 'Medium'
